...
/**
 * BattleFront is the display window for the coin toss and actual battle
 */
public class BattleFront extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Kommand Quest - Battle Front");
    ...
    /** SetLabels sets the initial army name and count labels
    */
    ...
    /** CommenceBattle starts the animations and battle
    */
    ...
    /** BattleLogic starts the BeginBattle method and returns a LindkedHashMap of the army results based on every 100 turns
    ...
    */
    ...
    /** CoinTossAnimation animates a coin toss
    */
    ...
    /** BeginBattleAnimation animates the initial battle animation
    */
    ...
    /** OngoingBattleAnimation continues the battle animation until the battle is over, then displays the winner or tie, and then displays the Play Again option window
    */
    ...
    /** DisplayFinalResults displays the final results of the battle at the bottom of the window
    */
    ...
    /** DetermineWhoStrikesFirst sets playerOne to true if even random number is drawn, else defaults to false
    */
